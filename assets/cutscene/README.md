...
인물 일러스트(`figure:`)는 별도 칸이다 — 논리 **300 x 360**(비율 5:6), 실제 390 x 468.
**권장: 600 x 720, 배경 투명 PNG.**
...
| `figure_director.png` | **인물 일러스트** — 나레이션 3컷 동안 배경 앞에 서는 연구소 총괄 관리자 |

인물 일러스트는 배경 위 **오른쪽**에 겹쳐 그려진다(세로로 긴 상반신/전신 권장).
