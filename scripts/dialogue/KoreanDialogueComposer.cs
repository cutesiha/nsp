...
public static class KoreanDialogueComposer
{
    ...
    private static string Build(DialogueContext ctx, DialogueResponsePlan plan)
    {
        ...
        // 핵심 문장은 무슨 일이 있어도 남는다(MaxSentences 가 1 인 캐릭터에서
    ...
    private static readonly Dictionary<string, string[]> Pools = new()
    {
        ...
        ["sheep|report.direct"] = new[] { "저, 저기... {iroom}에서 {what} 괜찮은 거 맞죠?", "관리자님...! {iroom}에서 {what} 어, 어떡하죠?" },
        ["sheep|report.indirect"] = new[] { "저, 저기... {iroom} 쪽에서 {sound} 괜찮은 거 맞죠?", "{iroom} 쪽에서 {sound} 제가 가야 하는 건 아니죠...?" },
        ...
        ["wolf|report.direct"] = new[] { "{iroom}에서 {what} 지시 바랍니다.", "{iroom}. {what} 확인이 필요합니다." },
        ["wolf|report.indirect"] = new[] { "{iroom} 쪽에서 {sound} 확인이 필요합니다.", "{iroom} 방향이었습니다. {sound} 지시 바랍니다." },
        ...
        ["dog|report.blackout"] = new[] { "관리자님, 전기가 나갔어요. 함부로 움직이지 않고 지시 기다릴게요.", "정전이에요. 비상등은 켜져 있어요. 어떻게 할까요?" },
        ["cat|report.blackout"] = new[] { "정전이에요. 제 위치는 확인되죠? 필요하면 바로 보내세요.", "불 나갔어요. 이대로 손 놓고 있을까요?" },
        ["sheep|report.blackout"] = new[] { "관리자님...? 여기 너무 어두워요... 저 가만히 있을까요?", "저, 아무것도 안 보여요... 어떡하죠?" },
        ["rabbit|report.blackout"] = new[] { "조명이 다 꺼졌어요! 관리자님, 저 여기 있어요!", "여보세요?! 완전 깜깜해요! 저 어떡해요?" },
        ["wolf|report.blackout"] = new[] { "정전 확인. 현재 위치 유지하겠습니다.", "전력 차단. 지시 바랍니다." },
        ["fox|report.blackout"] = new[] { "완전히 깜깜해졌네요. 지시 주시면 움직이죠.", "이런. 불이 다 나갔는데요. 어떻게 할까요?" },

        // ── 핵심: 지시에 대한 대답 ──────────────────────────────────────
        ["dog|accept"] = new[] { "알겠어요. 정리하고 바로 가 볼게요.", "제가 확인하고 다시 말씀드릴게요." },
        ["dog|decline"] = new[] { "알겠어요. 상황이 바뀌면 바로 다시 연락드릴게요.", "네, 여기서 자리 지킬게요." },
        ["cat|accept"] = new[] { "알겠어요. 빨리 끝내고 오죠.", "가죠." },
        ["cat|decline"] = new[] { "그럼 그대로 두죠. 나중에 더 커질 텐데요.", "네. 알겠어요." },
        ["sheep|accept"] = new[] { "제, 제가요...? 네... 빨리 보고 올게요.", "네... 다녀올게요." },
        ["sheep|decline"] = new[] { "네...! 다행이에요...", "네, 알겠어요. 여기 있을게요." },
        ["rabbit|accept"] = new[] { "네! 바로 가볼게요!", "알겠어요! 문제 있으면 또 전화할게요!" },
        ["rabbit|decline"] = new[] { "아... 네. 근데 진짜 괜찮은 거죠?", "알겠어요! 여기 있을게요!" },
        ["wolf|accept"] = new[] { "확인하겠습니다.", "이동합니다." },
        ["wolf|decline"] = new[] { "알겠습니다. 대기합니다.", "알겠습니다." },
        ...
        ["dog|opener.repeat"] = new[] { "아까 말씀드린 대로예요.", "다시 말씀드리면요," },
        ["cat|opener.repeat"] = new[] { "아까도 말씀드렸잖아요.", "또요?", "같은 걸 또 물으시네요." },
        ["sheep|opener.repeat"] = new[] { "아까 말씀드린 것처럼요,", "저, 아까랑 같은데요...", "음... 답은 같아요." },
        ["rabbit|opener.repeat"] = new[] { "아까 말씀드린 거랑 같아요.", "음, 아까도 말씀드렸는데요.", "다시 말씀드리면요," },
        ["wolf|opener.repeat"] = new[] { "말씀드린 대로입니다.", "같습니다." },
        ["fox|opener.repeat"] = new[] { "아까랑 같은 답인데요.", "다시 여쭤보시네요." },

        // ── 보정: 직접 보지 않았음 ──────────────────────────────────────
        ["dog|caveat.indirect"] = new[] { "직접 보지는 못했어요.", "제가 확인한 건 거기까지예요." },
        ["cat|caveat.indirect"] = new[] { "직접 본 건 아니에요." },
        ["sheep|caveat.indirect"] = new[] { "직접 본 건 아니에요... 제가 잘못 들은 걸 수도 있고요.", "직접 보진 못했어요..." },
        ["rabbit|caveat.indirect"] = new[] { "직접 본 건 아니에요!", "보진 못했어요!" },
        ["wolf|caveat.indirect"] = new[] { "직접 보진 못했습니다." },
        ["fox|caveat.indirect"] = new[] { "직접 본 건 아니고요.", "본 건 아니고 들은 거예요." },

        // ── 보정: 원인은 모름 ───────────────────────────────────────────
        ["dog|caveat.cause"] = new[] { "원인까지는 모르겠어요." },
        ["cat|caveat.cause"] = new[] { "원인은 저도 몰라요." },
        ["sheep|caveat.cause"] = new[] { "왜 그랬는지는... 잘 모르겠어요." },
        ["rabbit|caveat.cause"] = new[] { "왜 그런지는 모르겠어요!" },
        ["wolf|caveat.cause"] = new[] { "원인은 불명입니다." },
        ["fox|caveat.cause"] = new[] { "원인까지 아는 건 아니에요." },

        // ── 보조: 업무 ─────────────────────────────────────────────────
        ["dog|support.task"] = new[] { "맡은 일 계속하고 있었어요." },
        ["cat|support.task"] = new[] { "배치받은 일 하고 있었고요." },
        ["sheep|support.task"] = new[] { "하던 일 하고 있었어요." },
        ["rabbit|support.task"] = new[] { "열심히 하고 있었어요!" },
        ["wolf|support.task"] = new[] { "업무 중이었습니다." },
        ["fox|support.task"] = new[] { "제 일 하고 있었죠." },

        ["dog|support.taskname"] = new[] { "{task} 진행 중이에요." },
        ["cat|support.taskname"] = new[] { "{task} 하고 있어요." },
        ["sheep|support.taskname"] = new[] { "{task} 하는 중이에요..." },
        ["rabbit|support.taskname"] = new[] { "{task} 하고 있어요!" },
        ["wolf|support.taskname"] = new[] { "{task} 진행 중." },
        ["fox|support.taskname"] = new[] { "{task} 중이에요." },

        // ── 보조: 그 밖엔 없음 ──────────────────────────────────────────
        ["dog|support.nothing"] = new[] { "그 밖에는 특별한 건 없었어요." },
        ["cat|support.nothing"] = new[] { "그거 말곤 없어요." },
        ["sheep|support.nothing"] = new[] { "그거 말고는... 없었던 것 같아요." },
        ["rabbit|support.nothing"] = new[] { "그거 말고는 없었어요!" },
        ["wolf|support.nothing"] = new[] { "그 외에는 없습니다." },
        ["fox|support.nothing"] = new[] { "그거 말곤 조용했어요." },

        // ── 보조: 단서 붙이기 ───────────────────────────────────────────
        ["dog|support.hedge"] = new[] { "확실하지 않은 건 말씀 안 드릴게요.", "제가 본 건 여기까지예요." },
        ["cat|support.hedge"] = new[] { "확실한 건 아니고요." },
        ["wolf|support.hedge"] = new[] { "추측입니다." },
        ["sheep|support.hedge"] = new[] { "제가 잘못 본 걸 수도 있어요.", "확실하진 않아요.", "잠깐 본 거라서 확신은 못 하겠어요.", "제 느낌일 수도 있고요..." },
        ["rabbit|support.hedge"] = new[] { "제 생각엔 그래요.", "근데 제가 본 게 전부는 아니니까요." },
        ["fox|support.hedge"] = new[] { "제가 보고 있던 범위 안에서만요." },

        // ── 보조: 방해자 전략 ───────────────────────────────────────────
        ["dog|support.justify"] = new[] { "확인할 게 있어서 잠깐 자리를 옮겼어요." },
        ["cat|support.justify"] = new[] { "필요해서 잠깐 움직인 거예요." },
        ["sheep|support.justify"] = new[] { "잠깐... 확인할 게 있어서 갔어요." },
        ["rabbit|support.justify"] = new[] { "확인할 게 있어서 잠깐 갔었어요!" },
        ["wolf|support.justify"] = new[] { "확인 목적이었습니다." },
        ["fox|support.justify"] = new[] { "잠깐 확인할 게 있었거든요." },

        ["dog|support.minimize"] = new[] { "오래 있었던 건 아니에요." },
        ["cat|support.minimize"] = new[] { "잠깐이었어요." },
        ["sheep|support.minimize"] = new[] { "아주 잠깐이었어요..." },
        ["rabbit|support.minimize"] = new[] { "진짜 잠깐이었어요!" },
        ["wolf|support.minimize"] = new[] { "짧았습니다." },
        ["fox|support.minimize"] = new[] { "얼마 안 걸렸어요." },

        ["dog|support.vague"] = new[] { "정확한 시간까지는 기억이 잘 안 나요." },
        ["cat|support.vague"] = new[] { "일일이 다 기억 안 나는데요." },
        ["sheep|support.vague"] = new[] { "중간에 뭘 했는지는... 잘 기억이 안 나요." },
        ["rabbit|support.vague"] = new[] { "정확히는 기억이 안 나요!" },
        ["wolf|support.vague"] = new[] { "세부는 기억나지 않습니다." },
        ["fox|support.vague"] = new[] { "세세한 건 기억이 잘 안 나네요." },

        ["dog|support.redirect"] = new[] { "다만 {who} 씨 동선도 한번 봐 주시면 좋을 것 같아요." },
        ["cat|support.redirect"] = new[] { "{who} 씨 쪽이나 보시죠." },
        ["sheep|support.redirect"] = new[] { "그, {who} 씨는... 좀 이상했어요." },
        ["rabbit|support.redirect"] = new[] { "{who} 씨는 좀 이상했어요!" },
        ["wolf|support.redirect"] = new[] { "{who} 쪽을 확인하십시오." },
        ["fox|support.redirect"] = new[] { "{who} 씨가 뭘 했는지는 본인한테 물어보시는 게 빠를 텐데요." },

        // ── 보조: 오늘 마주친 적 있음(Q4) ───────────────────────────────
        ["dog|support.seen"] = new[] { "오늘도 같은 구역에서 봤어요." },
        ["cat|support.seen"] = new[] { "오늘 잠깐 같이 있었고요." },
        ["sheep|support.seen"] = new[] { "오늘 잠깐 봤어요." },
        ["rabbit|support.seen"] = new[] { "오늘도 봤어요!" },
        ["wolf|support.seen"] = new[] { "오늘 마주쳤습니다." },
        ["fox|support.seen"] = new[] { "오늘도 얼굴은 봤죠." },

        // ── 감정 ───────────────────────────────────────────────────────
        ["dog|emotion.alarm"] = new[] { "가볍게 넘길 일은 아닌 것 같았어요." },
        ["cat|emotion.alarm"] = new[] { "정상은 아니었죠." },
        ["sheep|emotion.alarm"] = new[] { "너무 놀랐어요." },
        ["rabbit|emotion.alarm"] = new[] { "진짜 깜짝 놀랐어요!" },
        ["fox|emotion.alarm"] = new[] { "쉽게 잊을 장면은 아니던데요." },

        ["dog|emotion.fear"] = new[] { "솔직히 좀 무서웠어요." },
        ["cat|emotion.fear"] = new[] { "기분 나빴어요." },
        ["sheep|emotion.fear"] = new[] { "아직도 좀 무서워요..." },
        ...
        ["dog|emotion.composed"] = new[] { "보고는 그때 바로 드렸어요." },
        ["wolf|emotion.composed"] = new[] { "그게 전부입니다." },

        // 꼬리질문 답변 ─────────────────────────────────────────────
        // 그 전에는 어디에 있었는가
        ["dog|prevloc.same"] = new[] { "계속 {room}에 있었어요.", "{room}에서 안 움직이고 있었어요." },
        ["cat|prevloc.same"] = new[] { "계속 {room}이요/요.", "{room}에 계속 있었어요." },
        ["sheep|prevloc.same"] = new[] { "쭉 {room}에 있었어요...", "{room}에서 안 나갔어요." },
        ["rabbit|prevloc.same"] = new[] { "계속 {room}에 있었어요!", "{room}에서 안 움직였어요!" },
        ["wolf|prevloc.same"] = new[] { "계속 {room}입니다.", "이동 없습니다." },
        ["fox|prevloc.same"] = new[] { "계속 {room}에 있었죠.", "{room}에서 안 나갔어요. 나갈 일도 없었고요." },

        ["dog|prevloc.moved"] = new[] { "그 전에는 {droom}에 있었어요.", "{droom}에서 {room}으로/로 옮겼어요." },
        ["cat|prevloc.moved"] = new[] { "{droom}에 있다가 왔어요.", "{droom}이요/요. 거기 있다가 옮겼어요." },
        ["sheep|prevloc.moved"] = new[] { "그 전에는... {droom}에 있었어요.", "{droom}에 있다가 {room}으로/로 갔어요." },
        ["rabbit|prevloc.moved"] = new[] { "그 전엔 {droom}에 있었어요!", "{droom}에 있다가 옮겼어요!" },
        ["wolf|prevloc.moved"] = new[] { "그 전에는 {droom}입니다.", "{droom}에서 이동했습니다." },
        ["fox|prevloc.moved"] = new[] { "그 전엔 {droom}에 있었어요.", "{droom}에 있다가 옮겼죠." },

        // 그 뒤에는 어떻게 했는가
        ["dog|nextact.stayed"] = new[] { "자리 지키면서 상황 지켜봤어요.", "그대로 {room}에 있었어요." },
        ["cat|nextact.stayed"] = new[] { "그냥 하던 일 계속했어요.", "안 움직였어요." },
        ["sheep|nextact.stayed"] = new[] { "무서워서 그냥 있었어요...", "그 자리에 계속 있었어요." },
        ["rabbit|nextact.stayed"] = new[] { "그냥 계속 있었어요! 나가도 되나 싶어서요.", "자리 지켰어요!" },
        ["wolf|nextact.stayed"] = new[] { "위치를 유지했습니다.", "그대로 있었습니다." },
        ["fox|nextact.stayed"] = new[] { "가만히 있었죠. 나설 이유가 없어서요.", "그냥 있었어요." },

        ["dog|nextact.moved"] = new[] { "그 뒤에 {droom}으로/로 옮겼어요.", "{droom} 쪽으로 갔어요." },
        ["cat|nextact.moved"] = new[] { "{droom}으로/로 갔어요.", "{droom}이요/요. 그쪽으로 옮겼어요." },
        ["sheep|nextact.moved"] = new[] { "그 다음엔... {droom}으로/로 갔어요.", "{droom} 쪽으로 옮겼어요." },
        ["rabbit|nextact.moved"] = new[] { "{droom}으로/로 갔어요!", "바로 {droom} 쪽으로 갔어요!" },
        ["wolf|nextact.moved"] = new[] { "{droom}으로/로 이동했습니다.", "이후 {droom}입니다." },
        ["fox|nextact.moved"] = new[] { "{droom}으로/로 옮겼어요.", "{droom} 쪽으로 갔죠." },

        // 당시 같이 있던 사람
        ["dog|present.alone"] = new[] { "혼자였어요.", "그 시간엔 저 혼자 있었어요." },
        ["cat|present.alone"] = new[] { "혼자였어요.", "저 혼자요." },
        ["sheep|present.alone"] = new[] { "혼자... 있었어요.", "저 혼자였어요." },
        ["rabbit|present.alone"] = new[] { "혼자였어요!", "저밖에 없었어요!" },
        ["wolf|present.alone"] = new[] { "혼자였습니다.", "동석자 없습니다." },
        ["fox|present.alone"] = new[] { "혼자였죠.", "아쉽게도 저 혼자요. 증인이 필요하신가 봐요?" },

        ["dog|present.with"] = new[] { "{dname} 씨랑 같이 있었어요.", "{dname} 씨가 같은 방에 있었어요." },
        ["cat|present.with"] = new[] { "{dname} 씨도 있었어요.", "{dname} 씨랑 같이 있었어요." },
        ["sheep|present.with"] = new[] { "{dname} 씨도 같이 있었어요.", "{dname} 씨가 있었어요... 아마요." },
        ["rabbit|present.with"] = new[] { "{dname} 씨도 있었어요!", "{dname} 씨랑 같이 있었어요!" },
        ["wolf|present.with"] = new[] { "{dname} 직원이 있었습니다.", "{dname}. 같은 방입니다." },
        ["fox|present.with"] = new[] { "{dname} 씨도 있었죠.", "{dname} 씨랑 같이 있었어요." },

        // 위치를 확인해 줄 사람
        ["dog|witness.alone"] = new[] { "확인해 줄 사람은 없어요. 그건 맞아요.", "같이 있던 사람은 없었어요." },
        ["cat|witness.alone"] = new[] { "없어요. 혼자였으니까요.", "없는데요." },
        ["sheep|witness.alone"] = new[] { "없어요... 혼자 있어서요.", "그, 그건 없어요..." },
        ["rabbit|witness.alone"] = new[] { "없어요! 혼자 있었거든요.", "아... 없네요." },
        ["wolf|witness.alone"] = new[] { "없습니다.", "증인 없습니다." },
        ["fox|witness.alone"] = new[] { "없네요. 하필 혼자였어서.", "그건 없어요. 곤란하게 됐네요." },

        ["dog|witness.with"] = new[] { "{dname} 씨가 확인해 줄 수 있을 거예요.", "{dname} 씨한테 물어보시면 돼요." },
        ["cat|witness.with"] = new[] { "{dname} 씨한테 물어보세요.", "{dname} 씨가 봤어요." },
        ["sheep|witness.with"] = new[] { "{dname} 씨가... 알 거예요.", "{dname} 씨한테 여쭤보시면 돼요." },
        ["rabbit|witness.with"] = new[] { "{dname} 씨요! 같이 있었어요!", "{dname} 씨한테 물어보세요!" },
        ["wolf|witness.with"] = new[] { "{dname}. 확인 가능합니다.", "{dname} 직원입니다." },
        ["fox|witness.with"] = new[] { "{dname} 씨한테 물어보시죠.", "{dname} 씨가 있었어요." },

        // 어떤 소리였는가
        ["dog|heard"] = new[] { "금속끼리 부딪치는 것 같은 둔한 소리였어요.", "짧고 무거운 소리였어요. 한 번이었어요." },
        ["cat|heard"] = new[] { "뭔가 크게 부딪치는 소리요.", "쾅 하고 한 번. 그게 다예요." },
        ["sheep|heard"] = new[] { "쿵... 하고 벽까지 울리는 소리였어요.", "무슨 소리인지는 잘 모르겠는데, 엄청 컸어요." },
        ["rabbit|heard"] = new[] { "쾅! 하고 엄청 크게 났어요!", "뭐가 터지는 것 같은 소리였어요!" },
        ["wolf|heard"] = new[] { "낮고 둔한 충격음. 한 번이었습니다.", "금속음입니다. 짧았습니다." },
        ["fox|heard"] = new[] { "둔탁하게 한 번. 기분 좋은 소리는 아니었어요.", "뭔가 무너지는 듯한 소리였죠." },

        // 직접 본 것인가
        ["dog|seen.saw"] = new[] { "네, 직접 봤어요.", "제 눈으로 봤어요." },
        ["cat|seen.saw"] = new[] { "네, 봤어요.", "직접 봤어요." },
        ["sheep|seen.saw"] = new[] { "네... 봤어요.", "직접 봤어요. 정말이에요." },
        ["rabbit|seen.saw"] = new[] { "네! 봤어요!", "제 눈으로 봤어요!" },
        ["wolf|seen.saw"] = new[] { "직접 봤습니다.", "확인했습니다." },
        ["fox|seen.saw"] = new[] { "네, 이건 직접 봤죠.", "봤어요. 이건 확실하고요." },

        ["dog|seen.heard"] = new[] { "아니요, 들은 것뿐이에요.", "본 건 아니에요. 소리만 들었어요." },
        ["cat|seen.heard"] = new[] { "아뇨. 소리만요.", "듣기만 했어요." },
        ["sheep|seen.heard"] = new[] { "아, 아니요... 소리만 들었어요.", "본 건 아니에요..." },
        ["rabbit|seen.heard"] = new[] { "아뇨! 소리만 들었어요.", "보진 못했어요!" },
        ["wolf|seen.heard"] = new[] { "아닙니다. 청각 정보뿐입니다.", "듣기만 했습니다." },
        ["fox|seen.heard"] = new[] { "아뇨, 들은 거예요.", "보진 못했죠. 벽 하나 사이라서요." },

        // 확신하는가
        ["dog|certain.sure"] = new[] { "네, 그건 확실해요.", "제가 본 건 확실해요." },
        ["cat|certain.sure"] = new[] { "확실해요.", "네. 확실하니까 말한 거예요." },
        ["sheep|certain.sure"] = new[] { "그건... 확실해요.", "네, 그건 맞아요." },
        ["rabbit|certain.sure"] = new[] { "확실해요!", "네! 그건 확실해요!" },
        ["wolf|certain.sure"] = new[] { "확실합니다.", "맞습니다." },
        ["fox|certain.sure"] = new[] { "그건 확실하죠.", "이건 장담해도 됩니다." },

        ["dog|certain.unsure"] = new[] { "확실하다고는 못 하겠어요.", "제가 본 것 이상은 말씀드리기 어려워요." },
        ["cat|certain.unsure"] = new[] { "글쎄요. 거기까진 몰라요.", "확실하냐고 하면 아니죠." },
        ["sheep|certain.unsure"] = new[] { "그건... 잘 모르겠어요.", "제가 잘못 안 걸 수도 있어요..." },
        ["rabbit|certain.unsure"] = new[] { "음... 그건 잘 모르겠어요.", "확실하진 않아요!" },
        ["wolf|certain.unsure"] = new[] { "단정할 수 없습니다.", "확인 못 했습니다." },
        ["fox|certain.unsure"] = new[] { "글쎄요. 장담은 못 하겠는데요.", "거기까진 모르죠. 제가 전부 볼 순 없잖아요." },

        // 구체적으로 어떤 상황이었는가
        ["dog|detail.direct"] = new[] { "{iroom}에서 {what}", "가까이에서 봤어요. {what}" },
        ["cat|detail.direct"] = new[] { "{what} 그게 전부예요.", "{iroom}에서 {what}" },
        ["sheep|detail.direct"] = new[] { "{what} 순식간이었어요.", "{iroom}에서요... {what}" },
        ["rabbit|detail.direct"] = new[] { "{what} 진짜 순식간이었어요!", "{iroom}에서 {what}" },
        ["wolf|detail.direct"] = new[] { "{what} 그 이상은 없습니다.", "{iroom}. {what}" },
        ["fox|detail.direct"] = new[] { "{what} 딱 그 정도예요.", "{iroom} 쪽에서 {what}" },

        ["dog|detail.indirect"] = new[] { "제가 말씀드릴 수 있는 건 소리까지예요.", "벽 너머라 상황까지는 몰라요." },
        ["cat|detail.indirect"] = new[] { "벽 너머라 그 이상은 몰라요.", "소리 말고는 없어요." },
        ["sheep|detail.indirect"] = new[] { "소리밖에 못 들어서... 그 이상은 몰라요.", "무슨 일인지까지는 정말 모르겠어요." },
        ["rabbit|detail.indirect"] = new[] { "소리만 들어서 그 이상은 몰라요!", "가서 본 게 아니라서요!" },
        ["wolf|detail.indirect"] = new[] { "청각 정보뿐입니다. 그 이상은 불명입니다.", "벽 너머입니다. 확인 불가." },
        ["fox|detail.indirect"] = new[] { "벽 하나 사이라 거기까지예요.", "소리 말곤 아는 게 없어요." },

        ["dog|detail.sight"] = new[] { "거기 있는 것까지만 봤어요.", "뭘 하고 있었는지까지는 못 봤어요." },
        ["cat|detail.sight"] = new[] { "거기 서 있는 것만 봤어요. 뭘 했는진 몰라요.", "자세히 볼 상황은 아니었어요." },
        ["sheep|detail.sight"] = new[] { "거기 있는 것만 봤어요... 뭘 했는지까지는 잘...", "무서워서 오래 못 봤어요." },
        ["rabbit|detail.sight"] = new[] { "거기 있는 건 봤는데 뭘 했는지는 몰라요!", "그냥 있는 것만 봤어요!" },
        ["wolf|detail.sight"] = new[] { "위치까지입니다. 행동 내용은 확인하지 못했습니다.", "본 것은 그 자리에 있었다는 것뿐입니다." },
        ["fox|detail.sight"] = new[] { "거기 있던 것까지만요. 그 이상은 저도 몰라요.", "굳이 붙어서 보진 않았거든요." },

        // 어디에서 봤는가
        ["dog|sightplace"] = new[] { "{room}에서 봤어요." },
        ["cat|sightplace"] = new[] { "{room}이요/요." },
        ["sheep|sightplace"] = new[] { "{room}에서요... 거기서 봤어요." },
        ["rabbit|sightplace"] = new[] { "{room}에서 봤어요!" },
        ["wolf|sightplace"] = new[] { "{room}입니다." },
        ["fox|sightplace"] = new[] { "{room}에서요." },

        // 그렇게 판단한 이유
        ["dog|reason.sight"] = new[] { "평소에 거기 있을 시간이 아니었거든요.", "그 시간에 거기 있을 이유가 없어 보여서요." },
        ["cat|reason.sight"] = new[] { "동선이 이상했으니까요.", "거기 있을 일이 아니잖아요." },
        ["sheep|reason.sight"] = new[] { "평소랑 달라 보여서요...", "표정이 좀... 이상했어요." },
        ["rabbit|reason.sight"] = new[] { "평소랑 완전 달랐거든요!", "거기 갈 이유가 없잖아요!" },
        ["wolf|reason.sight"] = new[] { "평소 동선과 달랐습니다.", "행동 순서가 부자연스러웠습니다." },
        ["fox|reason.sight"] = new[] { "그 시간에 거기 있을 이유가 없죠.", "평소랑 달랐거든요. 저는 그런 게 잘 보여서요." },

        ["dog|reason.move"] = new[] { "확인해 봐야 할 것 같았어요.", "보고드리기 전에 상황을 먼저 보려고 했어요." },
        ["cat|reason.move"] = new[] { "필요해서 갔어요.", "가야 할 일이 있었으니까요." },
        ["sheep|reason.move"] = new[] { "그, 확인할 게 있어서요...", "무서워서 그쪽으로 간 것도 있고요..." },
        ["rabbit|reason.move"] = new[] { "확인하고 싶어서 갔어요!", "궁금해서 가봤어요!" },
        ["wolf|reason.move"] = new[] { "확인 목적입니다.", "필요한 이동이었습니다." },
        ["fox|reason.move"] = new[] { "확인할 게 있었거든요.", "그럴 만한 이유가 있었죠. 자세히 말씀드릴 것까진 없고요." },

        ["dog|reason.opinion"] = new[] { "같이 일해 보니까 그렇게 느꼈어요.", "일하는 모습 보고 그렇게 생각했어요." },
        ["cat|reason.opinion"] = new[] { "일하는 거 보면 알죠.", "그냥 보면 알아요." },
        ["sheep|reason.opinion"] = new[] { "그냥... 그렇게 느꼈어요.", "제 느낌이라 확실하진 않아요." },
        ["rabbit|reason.opinion"] = new[] { "같이 일해보면 알아요!", "그냥 그런 느낌이에요!" },
        ["wolf|reason.opinion"] = new[] { "관찰한 대로입니다.", "근무 태도 기준입니다." },
        ["fox|reason.opinion"] = new[] { "같이 일해보면 보이죠.", "뭐, 인상이 그래요." },

        // 오늘도 평소와 같았는가 / 수상하다고 느낀 적
        ["dog|opinionq.today"] = new[] { "평소랑 크게 다르지 않았어요.", "오늘 특별히 달라 보이진 않았어요." },
        ["cat|opinionq.today"] = new[] { "똑같았어요.", "다를 게 있었나요?" },
        ["sheep|opinionq.today"] = new[] { "비슷했던 것 같아요...", "잘 모르겠어요. 오늘은 정신이 없어서요." },
        ["rabbit|opinionq.today"] = new[] { "네! 평소랑 똑같았어요!", "음... 비슷했던 것 같아요!" },
        ["wolf|opinionq.today"] = new[] { "차이 없습니다.", "특이사항 없습니다." },
        ["fox|opinionq.today"] = new[] { "평소랑 비슷했죠.", "글쎄요, 다들 오늘은 좀 예민하긴 했지만." },

        ["dog|opinionq.suspicion"] = new[] { "근거 없이 누굴 의심하고 싶진 않아요.", "그럴 만한 장면은 못 봤어요." },
        ["cat|opinionq.suspicion"] = new[] { "딱히요.", "그런 생각까진 안 해봤어요." },
        ["sheep|opinionq.suspicion"] = new[] { "그런 건... 잘 모르겠어요.", "제가 의심할 처지는 아니라서요..." },
        ["rabbit|opinionq.suspicion"] = new[] { "아뇨! 그런 생각은 안 해봤어요.", "설마요!" },
        ["wolf|opinionq.suspicion"] = new[] { "판단할 근거가 없습니다.", "없습니다." },
        ["fox|opinionq.suspicion"] = new[] { "여기선 다들 조금씩 수상하죠. 저 포함해서요.", "그런 건 관리자님 몫 아닌가요?" },

        // 추궁에 대한 대응
        ["dog|challenge.honest"] = new[] { "제가 아는 대로 말씀드렸어요. 기록이랑 같이 봐 주세요.", "숨긴 건 없어요. 확인해 보시면 알 거예요." },
        ["cat|challenge.honest"] = new[] { "말한 그대로예요. 확인해보세요.", "숨길 게 있으면 말을 안 했겠죠." },
        ["sheep|challenge.honest"] = new[] { "저, 저는 사실대로 말했어요... 정말이에요.", "숨긴 건 없어요..." },
        ["rabbit|challenge.honest"] = new[] { "저 진짜 그대로 말한 거예요!", "확인해보시면 아실 거예요!" },
        ["wolf|challenge.honest"] = new[] { "사실대로 말했습니다. 기록을 확인하십시오.", "숨긴 것 없습니다." },
        ["fox|challenge.honest"] = new[] { "제 말이 이상하게 들렸다면 다시 설명드리죠.", "숨길 이유가 없는데요. 뭘 보고 그러세요?" },

        ["dog|challenge.evasive"] = new[] { "기록이 그렇다면 제가 놓친 게 있을 거예요.", "그건 제가 잘 기억을 못 하겠어요." },
        ["cat|challenge.evasive"] = new[] { "그게 그렇게 중요한가요?", "잠깐 움직인 것까지 다 말해야 해요?" },
        ["sheep|challenge.evasive"] = new[] { "그, 그게... 기억이 잘 안 나서요...", "제가 뭘 잘못 말했나요...?" },
        ["rabbit|challenge.evasive"] = new[] { "어? 그게... 그건 별거 아니었어요!", "일부러 안 말한 건 아니에요!" },
        ["wolf|challenge.evasive"] = new[] { "그 부분은 기억나지 않습니다.", "말할 만한 일이 아니었습니다." },
        ["fox|challenge.evasive"] = new[] { "기록이 그렇다면 그런 거겠죠. 저는 기억이 좀 다르네요.", "굳이 말할 일이라고 생각을 못 했어요." },

        // ── 추궁받았을 때의 첫 반응(ChallengeResponse 전용) ──────────────
        ["dog|react.accused"] = new[] { "잠깐만요.", "네? 제가요?" },
        ["cat|react.accused"] = new[] { "저요?", "잠깐만요." },
        ["sheep|react.accused"] = new[] { "저, 저요...?", "네...?" },
        ["rabbit|react.accused"] = new[] { "네?! 저요?", "어, 잠깐만요." },
        ["wolf|react.accused"] = new[] { "말씀하십시오." },
        ["fox|react.accused"] = new[] { "저를요?", "이거 좀 곤란한데요." },

        // ── 묻지 않았지만 이 사람이라면 덧붙일 법한 한 마디 ───────────────
        ["dog|volunteer.noanomaly"] = new[] { "이상한 게 있었으면 바로 말씀드렸을 거예요.", "그래도 제가 못 본 곳까지는 장담 못 해요." },
        ["cat|volunteer.noanomaly"] = new[] { "있었으면 진작 말씀드렸어요.", "제가 못 본 데까지는 모르겠지만요." },
        ["sheep|volunteer.noanomaly"] = new[] { "제가 못 본 걸 수도 있어요...", "조용했어요. 정말요." },
        ["rabbit|volunteer.noanomaly"] = new[] { "있었으면 바로 전화드렸을 거예요.", "오늘은 좀 조용한 편이었어요.", "필요하면 제가 한번 더 돌아볼까요?" },
        ["wolf|volunteer.noanomaly"] = new[] { "기록에도 남은 것이 없습니다." },
        ["fox|volunteer.noanomaly"] = new[] { "뭔가 들으신 게 있으시면 말씀해주세요.", "제 쪽은 그랬다는 얘기예요." },

        ["dog|volunteer.nosight"] = new[] { "혹시 모르니까 같은 방에 있던 분들한테도 한번 물어봐 주세요." },
        ["cat|volunteer.nosight"] = new[] { "괜히 사람 이름 대고 싶진 않아요." },
        ["sheep|volunteer.nosight"] = new[] { "괜히 누굴 의심하고 싶진 않아서요..." },
        ["rabbit|volunteer.nosight"] = new[] { "근데 저도 좀 궁금하긴 해요.", "누가 이상했는지 아시면 제가 가서 볼게요." },
        ["wolf|volunteer.nosight"] = new[] { "추측으로 말하지 않겠습니다." },
        ["fox|volunteer.nosight"] = new[] { "애매한 걸로 사람 몰아가긴 싫어서요." },

        ["dog|volunteer.sight"] = new[] { "판단은 관리자님께 맡길게요." },
        ["cat|volunteer.sight"] = new[] { "그 이상은 저도 몰라요." },
        ["sheep|volunteer.sight"] = new[] { "제가 잘못 본 걸 수도 있어요." },
        ["rabbit|volunteer.sight"] = new[] { "그래서 저도 한 번 더 쳐다봤어요.", "뭔가 이상하다 싶었어요." },
        ["wolf|volunteer.sight"] = new[] { "판단은 하지 않겠습니다." },
        ["fox|volunteer.sight"] = new[] { "뭘 하고 있었는진 저도 모르죠." },

        // ── 끝맺음 ─────────────────────────────────────────────────────
        ["dog|closer"] = new[] { "더 필요한 거 있으면 말씀해 주세요." },
        ["cat|closer"] = new[] { "더 물어보실 거 있어요?" },
        ["sheep|closer"] = new[] { "이 정도밖에 못 도와드려서 죄송해요..." },
        ["rabbit|closer"] = new[] { "또 필요하면 말씀해주세요!" },
        ["wolf|closer"] = new[] { "이상입니다." },
        ...
        ["sheep|closer.back"] = new[] { "제가... 뭔가 잘못한 건가요?" },
    };
}
